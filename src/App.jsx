...
export default function App() {
  ...
  const saveEdit = () => {
    ...
    reset(); setToast({msg:"แก้ไขสำเร็จ — updatedAt อัพเดทแล้ว ✓",t:"s"});
  };
  ...
  const doDel = () => {
    ...
    setDelId(null); setToast({msg:"ลบแล้ว",t:"w"});
  };
